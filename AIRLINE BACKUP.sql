...
--
/*!50003 DROP FUNCTION IF EXISTS `CalculateTotalFareForFlight` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `CalculateTotalFareForFlight`(flightIDParam INT) RETURNS float
    READS SQL DATA
BEGIN
...
/*!50003 DROP PROCEDURE IF EXISTS `GetPassengerDetails` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetPassengerDetails`(IN PassengerIDParam INT)
BEGIN
    SELECT
        PassengerID,
        FirstName,
...
-- Dump completed on 2023-10-23 23:18:14
